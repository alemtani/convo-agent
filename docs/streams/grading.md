...
One per step, each runnable as written. **A0 (PR #86), A1 (PR #90) and A0.6
(this PR) are done** — their prompts are retired. A0.5 and A2 are independent
of each other and can run in parallel, in separate worktrees.
