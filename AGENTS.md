...
committed. Two dense-turn cases stay red until A3 (`milk-and-biscuits`
drops `order`; `computer-work-ni-ne` drops `partner_origin`). Do not
treat `clip-and-tea` going green as the multi-slot fix.
